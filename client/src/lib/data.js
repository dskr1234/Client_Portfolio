...
export const profile = {
  ...
  about: "Graduate student with strong full‑stack MERN skills and industry experience at Accenture. Passionate about performant UIs, reliable APIs, and clean architecture.",
  links: {
...
export const projects = [
  {
    ...
    link: "https://www.recruitemee.com",
    period: "Jan 2024 – Present",
    bullets: [
      "Full‑stack MERN SaaS helping 200+ students/professionals build ATS‑optimized resumes.",
      "RESTful APIs; scalable modular architecture; Razorpay payments; influencer referral system.",
      "Generated $3.5K in first quarter with 35% repeat rate."
    ],
...
export const education = [
  ...
  },
  {
    ...
    info: "2018 – 2022",
    coursework: ["Data Structures","Operating Systems","DBMS","Networks"] // you can adjust
  }
]
